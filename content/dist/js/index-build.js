...
var ISS = function () {
     ...
     */
				...
				ajax: function ajax(arg) {
					...
					$.ajax(opt).done(function (da) {
						arg["sucess"] && arg.sucess(da);
					}).fail(function (da) {
						arg["error"] && arg.error(da);
					});
				},

				getPlan: function getPlan() {
					var plan = navigator.userAgent;
				...
				alert: function alert(arg) {
					...
					$.extend(opt, arg);
					var $ele = $(str.replace(/\<\%title\%\>/ig, opt.title).replace(/\<\%content\%\>/ig, opt.content));
					$("body").append($ele);
					$ele.modal({
						show: true
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //滚动控件api http://www.360doc.com/content/14/0724/11/16276861_396699901.shtml
...
var tree = new Vue({
    el: ".contLeftList",
    components: {
        isssearch: function isssearch(callback) {
            return __webpack_require__.e/* require.ensure */(1).then((function (require) {
                return callback(__webpack_require__(333).default);
...
var Index = function () {
    ...
    _createClass(Index, [{
        key: "bindminHeight",
        value: function bindminHeight() {
            var h = _iss2.default.minHeight(".contLeftMenu,.contLeftList"),
                $rb = $(".contentRightBoxTen"),
                $rb2 = $(".contentRightBox");
        ...
        value: function resize() {
            var $rb = $(".contLeftMenu,.contLeftList"),
                $rb2 = $(".contentRightBox"),
                h = $(window).height() - 60;
...
var ClassIndex = new Index();
exports.default = ClassIndex;
...
var Home = function Home(callback) {
    return __webpack_require__.e/* require.ensure */(0).then((function (require) {
        return callback(__webpack_require__(332).default);
    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var routes = [{
